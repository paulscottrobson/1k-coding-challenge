...
case 0x2f: // *** dec rf ***
    R[15]--;break;
case 0x30: // *** br * ***
    FETCHBR();BRANCH();;break;
case 0x32: // *** bz * ***
    FETCHBR();if (D == 0) BRANCH();;break;
case 0x33: // *** bdf * ***
    FETCHBR();if (DF != 0) BRANCH();;break;
case 0x34: // *** b1 * ***
    FETCHBR();if (EFLAG1() != 0) BRANCH();;break;
case 0x35: // *** b2 * ***
    FETCHBR();if (EFLAG2() != 0) BRANCH();;break;
case 0x36: // *** b3 * ***
    FETCHBR();if (EFLAG3() != 0) BRANCH();;break;
case 0x37: // *** b4 * ***
    FETCHBR();if (EFLAG4() != 0) BRANCH();;break;
case 0x38: // *** skp ***
    R[P]++;break;
case 0x3a: // *** bnz * ***
    FETCHBR();if (D != 0) BRANCH();;break;
